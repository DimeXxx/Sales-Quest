...
function seedData() {
  ...
  const products = [
    { id: "p1", name: "Seagate Skyhawk HDD 8TB", sku: "ST8000VX010", category: "Storage", description: "Жёсткий диск для видеонаблюдения 24/7, оптимизирован под NVR-нагрузку.", price: 189, stock: 200, initialStock: 200, imageUrl: null },
    { id: "p2", name: "Hikvision DS-2CD2143G2-I", sku: "IPC-2143G2", category: "IP Camera", description: "4MP купольная IP-камера с ИК-подсветкой до 30м и AcuSense-детекцией.", price: 96, stock: 80, initialStock: 80, imageUrl: null },
    { id: "p3", name: "Hikvision DS-7616NI-K2 NVR", sku: "NVR-7616K2", category: "NVR", description: "16-канальный сетевой видеорегистратор с поддержкой 4K вывода.", price: 340, stock: 40, initialStock: 40, imageUrl: null },
    { id: "p4", name: "HiLook IPC-B140H", sku: "HL-B140H", category: "IP Camera", description: "Бюджетная 4MP цилиндрическая камера, ИК до 30м, EXIR-технология.", price: 54, stock: 60, initialStock: 60, imageUrl: null },
    { id: "p5", name: "Hikvision DS-K1T343 Access Terminal", sku: "AC-K1T343", category: "Access Control", description: "Терминал контроля доступа с распознаванием лиц и картой Mifare.", price: 410, stock: 60, initialStock: 60, imageUrl: null },
    { id: "p6", name: "WD Purple Surveillance HDD 4TB", sku: "WD40PURZ", category: "Storage", description: "Диск для видеонаблюдения с AllFrame AI, до 64 камер на один диск.", price: 112, stock: 150, initialStock: 150, imageUrl: null },
    { id: "p7", name: "Hikvision DS-2DE4425IW-DE PTZ", sku: "PTZ-4425", category: "PTZ Camera", description: "4MP PTZ-камера с 25x оптическим зумом и автослежением.", price: 780, stock: 20, initialStock: 20, imageUrl: null },
    { id: "p8", name: "HiLook NVR-108MH-D/8P", sku: "HL-108MHD8P", category: "NVR", description: "8-канальный NVR со встроенным PoE-коммутатором на 8 портов.", price: 165, stock: 50, initialStock: 50, imageUrl: null },
    { id: "p9", name: "Hikvision VMS License Pack 32ch", sku: "LIC-VMS32", category: "Software", description: "Лицензия на управление видео для 32 каналов, бессрочная.", price: 520, stock: 48, initialStock: 48, imageUrl: null },
    { id: "p10", name: "Hikvision DS-K2604T Controller", sku: "AC-K2604T", category: "Access Control", description: "Контроллер доступа на 4 двери с поддержкой TCP/IP и RS-485.", price: 265, stock: 220, initialStock: 220, imageUrl: null },
  ];
